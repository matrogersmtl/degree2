...
from degree2.vector_valued_smfs import vector_valued_siegel_modular_forms as vvld_smfs
...
class TestVectorValued(unittest.TestCase):
    ...
    def test_t_2_action(self):
        ...
        self.assertTrue(all([F10.hecke_operator(2, t) == ev2 * F10[t] for t in prec5]))

    # @skip("OK")
    def test_differential_operator(self):
        def load_cache(f):
            return SymWtModFmElt.load_from(
                opath.join(data_dir("vector_valued_differential"), f)
            )
        ...
        t_det_sym4_e4_e4_e6 = load_cache("triple_det_sym4_e4_e4_e6_prec10.sobj")
        t_det_sym4_e4_e6_x12 = load_cache("triple_det_sym4_e4_e6_x12_prec10.sobj")
        ...
        self.assertEqual(rankin_cohen_pair_det2_sym(4, es4, es6), p_det2_e4_e6)
        # prec 10
        ...
        self.assertEqual(
            rankin_cohen_triple_det_sym4(es4, es6, x12), t_det_sym4_e4_e6_x12
        )
