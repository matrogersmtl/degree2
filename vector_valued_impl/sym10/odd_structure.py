...
def _sym10_wt15_consts():
    vs = [
        ...
        [
            ...
            QQ(0),
            QQ(7134) / QQ(1105),
            -QQ(23749) / QQ(2316625920),
            QQ(1079) / QQ(1020),
            -QQ(50573) / QQ(1092),
            QQ(2489467) / QQ(416992665600),
            QQ(0),
        ],
    ]
    consts = sym10_19_consts + [_sym10_wt19_mul_const()]
...
def gen_consts():
    ...
    res = [_sym10_wt9_const(), _sym10_wt11_const(), _sym10_wt13_const()]
    res.extend(_sym10_wt15_consts())
    res.extend(_sym10_wt17_consts())
